...
A struct representing a laser sensor.

# Fields
- `model::String`: The model name of the laser.
- `position`: The position of the laser.
- `orientation`: The orientation of the laser.
- `update_rate::Float64`: The update rate of the laser.
- `h_fov::Float64`: The horizontal field of view of the laser.
- `v_fov::Float64`: The vertical field of view of the laser.
- `min_range::Float64`: The minimum range of the laser.
- `max_range::Float64`: The maximum range of the laser.
- `cost::Float64`: The cost of the laser.
- `power::Float64`: The power consumption of the laser.
"""
