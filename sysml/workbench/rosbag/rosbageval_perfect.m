...
par_ttc= A(:,2)
%par_cost = A(:,3)
scatter(par_path,par_ttc, 80, "filled") 
...
figure (4)
scatter(par_path2,par_ttc2,'filled')   % draw the scatter plot
ax = gca;
ax.XDir = 'reverse';
view(-31,14)
xlabel('Path Length (m)')
...
par_path2 = Acopy(:,1)
par_ttc2= Acopy(:,2)
scatter(par_path2,par_ttc2, 80, "filled") 
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
