# PERFECT bring-up, as measured

The full record of the end-to-end bring-up on the `dummy` example, moved here unchanged from
[`../README.md`](../README.md), which keeps the short version.
