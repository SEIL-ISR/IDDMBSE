...
| B1 | IV-B.1, the contested-terrain range | [`B1-contested-terrain-range/`](B1-contested-terrain-range/README.md) | none — this directory holds no scripts of its own | Isaac Sim, a local install with a GPU | nothing directly; it points at `isaacsim/`, which is authoritative for the range | not verified in this release; see `isaacsim/README.md` for what was checked there |
